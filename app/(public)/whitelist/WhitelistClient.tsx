...
import {
  ...
  Tag, HeadphonesIcon, Pencil, ChevronDown,
} from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto text-center">
        ...
        >
          {"Gestiona tu negocio de autónomo.".split(" ").map((w, i) => (
        ...
        <p className="hero-sub text-[13px] sm:text-[16px] text-white/50 leading-relaxed mb-5 sm:mb-10 max-w-lg mx-auto">
          La plataforma todo-en-uno para autónomos y pequeños negocios en España.
          <br />
...
const FAQ_ITEMS = [
  {
    q: "¿Qué es ClientLabs?",
    a: "ClientLabs es una plataforma de gestión todo en uno para autónomos y pymes en España. Centraliza leads, clientes, proveedores, facturas con Verifactu, presupuestos, albaranes, tareas, proyectos y automatizaciones en un solo lugar. Pensada para los 3,4 millones de autónomos en España que gestionan su negocio con WhatsApp y Excel.",
  },
  {
    q: "¿Para quién es ClientLabs?",
    a: "Para autónomos, freelancers y pequeños negocios de 1 a 10 personas en España. Es especialmente útil para fontaneros, electricistas, agencias de marketing, consultores, diseñadores, fisioterapeutas, nutricionistas y cualquier profesional que necesite gestión profesional sin la complejidad de herramientas para grandes empresas.",
  },
  {
    q: "¿En qué se diferencia de Holded o Quipu?",
    a: "ClientLabs es la única plataforma que combina CRM, facturación con Verifactu, captación de leads y automatizaciones en un solo producto pensado para autónomos en España. Holded está orientado a empresas medianas y resulta demasiado complejo y caro para autónomos. Quipu solo hace facturación, sin CRM ni gestión de leads. Con ClientLabs tienes todo desde el primer día.",
  },
  {
    q: "¿Cuánto cuesta ClientLabs?",
    a: "ClientLabs tiene planes desde 24,99€/mes con IVA incluido. Los early adopters que se apunten antes del lanzamiento consiguen un 50% de descuento de por vida. Habrá una prueba gratuita de 14 días con acceso completo sin necesidad de tarjeta de crédito.",
  },
  {
    q: "¿ClientLabs cumple con Verifactu y la normativa fiscal española?",
    a: "Sí. ClientLabs está preparado para la normativa Verifactu (Real Decreto 1007/2023) de facturación electrónica en España. Las facturas incluyen los tipos de IVA correctos para España, firma digital y QR verificable por la AEAT.",
  },
  {
    q: "¿Cuándo lanza ClientLabs?",
    a: "El lanzamiento oficial es el 23 de junio de 2026. Los que estén en la lista de espera serán los primeros en entrar con ventajas exclusivas de early adopter: 1 mes gratis, 50% de descuento de por vida y acceso prioritario al producto.",
  },
]
  ...
  return (
    <section className="bg-white py-20 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-[28px] sm:text-[36px] font-bold text-[#0B1F2A] leading-tight mb-3">
            Preguntas frecuentes
          </h2>
          <p className="text-[14px] text-slate-500">
            Todo lo que necesitas saber antes de apuntarte.
          </p>
        </div>
          ...
          {FAQ_ITEMS.map((faq, i) => (
            ...
            >
              <summary className="flex items-center justify-between cursor-pointer px-5 py-4 text-[14px] font-semibold text-[#0B1F2A] [list-style:none] select-none [&::-webkit-details-marker]:hidden">
                {faq.q}
                <ChevronDown className="h-4 w-4 text-slate-400 shrink-0 ml-3 group-open:rotate-180 transition-transform duration-200" />
              </summary>
              <p className="px-5 pb-5 text-[13px] text-slate-600 leading-relaxed">
                {faq.a}
              </p>
            </details>
          ))}
