...
function LogRow({ log }: { log: AdminLog }) {
 ...
 <div className="flex items-center justify-between p-4 hover:bg-[var(--bg-card)] transition-colors">
 <div className="flex-1 space-y-1">
 <div className="flex items-center gap-2">
 <ActionBadge action={log.action} />
 <span className="text-[var(--text-secondary)] text-sm">by</span>
 <span className="text-[var(--text-primary)] font-medium">{log.adminEmail}</span>
 </div>
 {log.targetEmail && (
 <p className="text-[var(--text-secondary)] text-sm">
 Target: <span className="text-[var(--text-secondary)]">{log.targetEmail}</span>
 </p>
 )}
 ...
 <div className="bg-[var(--bg-card)] rounded p-3 text-xs font-mono text-[var(--text-secondary)]">
