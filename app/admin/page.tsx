...
export default async function AdminDashboard() {
 ...
 <Card className="bg-[var(--bg-card)] border-[var(--border-subtle)]">
 <CardHeader>
 <CardTitle className="text-[var(--text-primary)] text-sm">Plan Distribution</CardTitle>
 </CardHeader>
 <CardContent className="space-y-2">
 <div className="flex justify-between text-sm">
 <span className="text-[var(--text-secondary)]">FREE</span>
 <span className="text-[var(--text-primary)] font-medium">{stats.plans.free}</span>
 </div>
 <div className="flex justify-between text-sm">
 <span className="text-[var(--text-secondary)]">PRO</span>
 <span className="text-[var(--text-primary)] font-medium">{stats.plans.pro}</span>
 </div>
 <div className="flex justify-between text-sm">
 <span className="text-[var(--text-secondary)]">ENTERPRISE</span>
 <span className="text-[var(--text-primary)] font-medium">{stats.plans.enterprise}</span>
 </div>
 </CardContent>
 </Card>
 ...
 <Card className="bg-[var(--bg-card)] border-[var(--border-subtle)]">
 <CardHeader>
 <CardTitle className="text-[var(--text-primary)] text-sm">Active Sessions</CardTitle>
 </CardHeader>
 <CardContent>
 ...
 <Card className="bg-[var(--bg-card)] border-[var(--border-subtle)]">
 <CardHeader>
 <CardTitle className="text-[var(--text-primary)] text-sm">Last Backup</CardTitle>
 </CardHeader>
 <CardContent>
 {stats.lastBackup ? (
 <>
 ...
 ? "bg-[var(--bg-card)] text-[var(--critical)] border-[var(--critical)]"
 ...
 <p className="text-[var(--text-secondary)] text-sm">No backups yet</p>
 )}
 </CardContent>
 </Card>
 </div>
 ...
 <Card className="bg-[var(--bg-card)] border-[var(--border-subtle)]">
 <CardHeader>
 <CardTitle className="text-[var(--text-primary)]">Recent User Activity</CardTitle>
 </CardHeader>
 <CardContent>
 ...
 <p className="text-[var(--text-secondary)] text-center py-4">No recent users</p>
 )}
 </CardContent>
 </Card>
 ...
 <Card className="bg-[var(--bg-card)] border-[var(--border-subtle)] hover:bg-[var(--bg-card)] transition-colors cursor-pointer">
 <CardHeader>
