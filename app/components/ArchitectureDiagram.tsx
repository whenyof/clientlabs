...
export const ArchitectureDiagram = memo(function ArchitectureDiagram() {
 ...
 <div className="absolute left-2 top-0 bottom-0 w-px bg-[var(--bg-card)]" />

 {/* Núcleo */}
 <motion.div variants={fadeUp} className="relative mb-6">
 <div className="absolute -left-[7px] top-3 h-3 w-3 rounded-full bg-[var(--accent-soft)]-primary shadow-sm" />
 ...
 <p className="text-[11px] text-[var(--text-secondary)]">Núcleo central</p>
 </div>
 </div>
 </div>
 </motion.div>
 ...
 >
 <div className="absolute -left-[7px] top-4 h-3 w-3 rounded-full bg-[var(--accent-soft)]-primary/80 shadow-sm" />
 <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-4 backdrop-blur">
 <div className="flex items-center gap-3">
 <motion.span
 ...
 className="h-2.5 w-2.5 rounded-full bg-[var(--accent-soft)]-primary shadow-sm"
 />
 <p className="text-sm font-semibold text-[var(--text-secondary)]">{module.name}</p>
 </div>
 <p className="mt-1 text-[11px] text-[var(--text-secondary)]">{module.desc}</p>
 </div>
 </motion.div>
 ))}
 </div>
 ...
 <p className="mb-1 text-sm font-semibold text-[var(--text-secondary)]">{module.name}</p>
 <p className="text-[11px] text-[var(--text-secondary)] leading-relaxed">{module.desc}</p>
 </motion.div>
 ))}
 </div>
 </div>
