...
export default function ContactoClient() {
 ...
 <span className="inline-flex items-center rounded-full border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 py-1 text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">
 Respuesta media: &lt; 2h
 </span>
 <h1 className="text-4xl md:text-6xl font-semibold leading-tight">
 Habla con el <span className="text-[var(--accent)]-hover font-semibold">equipo</span> de ClientLabs
 </h1>
 <p className="text-[var(--text-secondary)] text-base md:text-lg max-w-3xl">
 Te ayudamos a diseñar tu sistema operativo.{" "}
 <span className="text-[var(--accent)]-hover font-semibold">Soporte</span> real. Respuestas humanas.
 </p>
 ...
 <p className="text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">Soporte humano</p>
 <h2 className="text-3xl md:text-5xl font-semibold">
 Operaciones reales requieren{" "}
 <span className="text-[var(--accent)]-hover font-semibold">resultados</span> reales
 </h2>
 <p className="text-[var(--text-secondary)]">
 Infraestructura de <span className="text-[var(--accent)]-hover font-semibold">soporte</span>, onboarding guiado y
 ...
 <div className="rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 md:p-8 backdrop-blur shadow-sm reveal">
 ...
 <label htmlFor={field.id} className="text-sm text-[var(--text-secondary)]">
 {field.label}
 </label>
 <input
 id={field.id}
 ...
 className="w-full rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 py-3 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] focus:border-[var(--border-subtle)] focus:outline-none"
 />
 {errors[field.id as keyof FormState] && (
 <p className="text-xs text-[var(--critical)]">Campo requerido</p>
 )}
 </div>
 ))}
 ...
 className="w-full rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 py-3 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] focus:border-[var(--border-subtle)] focus:outline-none"
 />
 {errors.message && <p className="text-xs text-[var(--critical)]">Campo requerido</p>}
 </div>

 <button
 type="submit"
 className="w-full rounded-full bg-[var(--bg-card)] px-4 py-3 text-sm font-semibold shadow-sm shadow-sm transition hover:shadow-sm disabled:opacity-60"
 ...
 {status === "success" && (
 <p className="text-sm text-[var(--accent)]">Mensaje enviado. Te respondemos en menos de 2h.</p>
 )}
 {status === "error" && (
 <p className="text-sm text-[var(--critical)]">Completa los campos para enviar tu consulta.</p>
 )}
 </form>
 </div>
 </div>
 ...
 <p className="text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">Infraestructura de confianza</p>
 <h2 className="text-3xl md:text-5xl font-semibold">
 <span className="text-[var(--accent)]-hover font-semibold">Soporte</span> humano para operaciones reales
 </h2>
 ...
 <span className="text-[var(--accent)]-hover font-semibold">decisiones</span> basadas en datos.
 </p>
 <div className="grid gap-4 md:grid-cols-3">
 {["Onboarding guiado", "Playbooks operativos", "Acompañamiento real"].map((item) => (
 <div key={item} className="rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 backdrop-blur">
 ...
 <p className="text-[var(--text-secondary)]">
 Estamos listos para darte <span className="text-[var(--accent)]-hover font-semibold">ayuda</span> y escalar con
 control.
 </p>
