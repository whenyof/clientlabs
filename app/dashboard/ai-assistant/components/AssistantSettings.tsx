...
export function AssistantSettings() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-2">Configuración del Asistente IA</h3>
        <p className="text-[var(--text-secondary)]">Personaliza cómo funciona tu asistente inteligente</p>
      </div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h4 className="text-lg font-semibold text-[var(--text-primary)]">Configuración General</h4>
            <p className="text-[var(--text-secondary)] text-sm">Ajustes principales del comportamiento IA</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full h-2 bg-[var(--bg-surface)] rounded-lg appearance-none cursor-pointer slider"
              />
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h4 className="text-lg font-semibold text-[var(--text-primary)]">Notificaciones</h4>
            <p className="text-[var(--text-secondary)] text-sm">Cómo y cuándo recibir alertas</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-[var(--bg-card)] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[var(--text-primary)] font-medium">Recomendaciones urgentes</div>
                <div className="text-[var(--text-secondary)] text-sm">Alertas de prioridad alta</div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-[var(--bg-card)] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[var(--text-primary)] font-medium">Resumen diario</div>
                <div className="text-[var(--text-secondary)] text-sm">Informe de actividad del día</div>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
          ...
          <div className="flex items-center justify-between p-4 bg-[var(--bg-card)] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[var(--text-primary)] font-medium">Alertas de riesgo</div>
                <div className="text-[var(--text-secondary)] text-sm">Clientes en riesgo de churn</div>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-[var(--text-secondary)] text-sm">Funciones automáticas activas</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-[var(--bg-card)] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[var(--text-primary)] font-medium">Generación automática de emails</div>
                <div className="text-[var(--text-secondary)] text-sm">Crea emails personalizados automáticamente</div>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
          ...
          <div className="flex items-center justify-between p-4 bg-[var(--bg-card)] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[var(--text-primary)] font-medium">Scoring automático de leads</div>
                <div className="text-[var(--text-secondary)] text-sm">Clasifica leads automáticamente por score</div>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
