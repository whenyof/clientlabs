              ...
              <div className="p-4 border-b border-[var(--border-subtle)]">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-[var(--text-secondary)] text-xs">Siempre disponible</div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 gap-2">
                  {quickActions.map((action, index) => (
                    <motion.button
                      ...
                      className="flex items-center gap-2 p-3 bg-[var(--bg-main)] hover:bg-[var(--bg-surface)] rounded-lg transition-colors text-left"
