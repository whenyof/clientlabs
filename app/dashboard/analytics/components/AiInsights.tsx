  ...
  return (
    <AnimatedCard delay={0.7}>
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {emptyInsights.length === 0 ? (
            <div className="col-span-full py-8 text-center text-[var(--text-secondary)]">
              <p className="text-[var(--text-secondary)]">Sin insights de IA</p>
            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <motion.h4
                    className="text-[var(--text-primary)] font-semibold mb-2 leading-tight"
        ...
        {/* Summary stats */}
        <motion.div
          className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 border-t border-[var(--border-subtle)]"
        ...
        >
          <div className="flex items-center justify-between">
            ...
            >
              ...
              />
              <div>
                <div className="text-[var(--text-primary)] font-medium">IA activa y aprendiendo</div>
                <div className="text-sm text-[var(--text-secondary)]">Última actualización: hace 5 minutos</div>
              </div>
            </motion.div>
            <motion.button
