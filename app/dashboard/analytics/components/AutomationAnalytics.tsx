    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {kpis.map((kpi, index) => {
          const Icon = kpi.icon
          return (
            <div key={index} className="bg-[var(--bg-surface)] rounded-lg p-4">
            ...
            <div key={index} className="bg-[var(--bg-surface)] rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-[var(--text-primary)] font-medium">{automation.name}</span>
                </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1">
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="text-[var(--text-primary)] font-medium">{automation.success}%</span>
                  </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-[var(--bg-surface)] rounded-lg p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h5 className="text-[var(--text-primary)] font-medium">Ahorro económico</h5>
          </div>
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-[var(--text-secondary)]">Coste evitado</span>
              <span className="text-green-400">€12,400</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[var(--text-secondary)]">ROI mensual</span>
              <span className="text-green-400">340%</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[var(--text-secondary)]">Payback</span>
      ...
      <div className="bg-gradient-to-r from-purple-600/10 to-blue-600/10 border border-purple-500/20 rounded-lg p-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex items-start gap-2">
            ...
            <span className="text-[var(--text-secondary)]">Implementar chatbots reduciría tiempo de respuesta en un 60%</span>
          </div>
        </div>
      </div>
    </div>
