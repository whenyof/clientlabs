  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="space-y-3">
          {[
            ...
            >
              <span className="text-[var(--text-primary)] font-medium">{cashflow.month}</span>
              <div className="flex items-center gap-4">
                ...
                <div className="text-right min-w-20">
                  <div className="text-[var(--text-primary)] font-bold">{formatCurrency(cashflow.net)}</div>
                  <div className="text-xs text-[var(--text-secondary)]">neto</div>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      >
        ...
        >
          <h5 className="text-[var(--text-primary)] font-medium mb-3">Ratios de liquidez</h5>
          <div className="space-y-2">
            {[
              ...
              >
                <span className="text-[var(--text-secondary)]">{ratio.label}</span>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.02 }}
        >
          <h5 className="text-[var(--text-primary)] font-medium mb-3">Eficiencia operativa</h5>
          <div className="space-y-2">
            {[
