    ...
    <AnimatedCard className="p-6" delay={0.4}>
      ...
      {data.length === 0 ? (
        <div className="py-12 text-center text-[var(--text-secondary)]">
          <p className="text-[var(--text-secondary)]">Sin datos de embudo</p>
...
function FunnelStage({
  ...
  return (
    ...
    >
      ...
      <div className="relative h-8 bg-[var(--bg-surface)] rounded-lg">
        <motion.div
        ...
        {nextStage && (
          <div className="absolute inset-0 flex items-center justify-center text-xs text-[var(--text-primary)] bg-[var(--bg-main)]/50 rounded">
