  ...
  return (
    ...
    >
          ...
          {data.chartData.map((source, index) => (
            ...
            >
              ...
              <div className="text-right">
                <div className="text-[var(--text-primary)] font-bold">{source.value}</div>
                <div className="text-sm text-[var(--text-secondary)]">
      ...
      >
        ...
        >
          <h5 className="text-[var(--text-primary)] font-medium mb-2">Calidad de leads</h5>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.02 }}
        >
          <h5 className="text-[var(--text-primary)] font-medium mb-2">Tasa de respuesta</h5>
          <motion.div
          ...
          <div className="text-sm text-[var(--text-secondary)]">+12% vs período anterior</div>
        </motion.div>
      </motion.div>
    </motion.div>
  )
