    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="text-sm text-[var(--text-secondary)]">Leads generados</div>
        </motion.div>
        <motion.div
          className="bg-[var(--bg-surface)] rounded-lg p-4"
          whileHover={{ scale: 1.02 }}
      ...
      <motion.div
        className="relative h-80 bg-[var(--bg-card)] rounded-lg border border-[var(--border-subtle)] p-4"
      ...
      >
        {chartData.length === 0 ? (
          <div className="flex items-center justify-center h-full text-[var(--text-secondary)]">
            <p className="text-[var(--text-secondary)]">Sin datos de rendimiento</p>
        ...
        {isLoading && (
          <motion.div
            className="absolute inset-0 bg-[var(--bg-card)] flex items-center justify-center rounded-lg"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          >
            <div className="flex items-center gap-2 text-[var(--text-primary)]">
              <div className="w-5 h-5 border border-[var(--border-subtle)] border-t-transparent rounded-full animate-spin" />
