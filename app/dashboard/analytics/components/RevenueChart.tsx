    ...
    <div className="bg-[var(--bg-card)] backdrop-blur-xl border border-[var(--border-subtle)] rounded-xl p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1 text-sm">
            <div className="w-3 h-3 bg-[var(--bg-main)]0 rounded"></div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <p className="text-2xl font-bold text-[var(--text-primary)]">€<ClientNumber value={latestValue} /></p>
        ...
        {REVENUE_DATA.map((data, index) => (
          <div key={data.month} className="flex-1 flex flex-col items-center gap-2">
            <div className="relative w-full flex items-end gap-1">
              {/* Previous month bar */}
              <div
                className="bg-[var(--bg-surface)] rounded-t w-1/2"
