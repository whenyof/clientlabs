  ...
  return (
    ...
    >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="text-right">
                  <div className="text-[var(--text-primary)] font-bold">{formatCurrency(month.value)}</div>
                  <div className="text-sm text-[var(--text-secondary)]">
                    {index > 0
      ...
      >
        ...
        >
          <h5 className="text-[var(--text-primary)] font-medium mb-2">Ticket Promedio</h5>
          <div className="text-2xl font-bold text-green-400 mb-1">€403</div>
          <div className="text-sm text-[var(--text-secondary)]">+5.2% vs mes anterior</div>
        </motion.div>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.02 }}
        >
          <h5 className="text-[var(--text-primary)] font-medium mb-2">Tasa de Conversión</h5>
          <div className="text-2xl font-bold text-blue-400 mb-1">12.8%</div>
          <div className="text-sm text-[var(--text-secondary)]">+2.1% vs mes anterior</div>
        </motion.div>
