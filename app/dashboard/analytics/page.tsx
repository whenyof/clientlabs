...
export default function AnalyticsPage() {
  ...
  return (
    <DashboardContainer>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-[var(--text-primary)]">{a.pageTitle}</h1>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          >
            ...
            <div className="flex gap-3">
              <motion.button
                className="flex items-center gap-2 px-4 py-2 bg-[var(--bg-main)] hover:bg-[var(--bg-surface)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] rounded-lg transition-colors border border-[var(--border-subtle)]"
