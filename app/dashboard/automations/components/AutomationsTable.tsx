  ...
  return (
    ...
    >
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-700/50">
            {filteredAutomations.length === 0 ? (
              <tr>
                <td colSpan={9} className="px-6 py-16 text-center text-[var(--text-secondary)]">
                  <p className="text-[var(--text-secondary)]">Sin automatizaciones</p>
              ...
              >
                <td className="px-6 py-4">
                  <div>
                    <div className="text-[var(--text-primary)] font-medium">{automation.name}</div>
                    <div className="text-[var(--text-secondary)] text-sm max-w-xs truncate">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    <motion.button
                      ...
                      className="p-1.5 text-[var(--text-secondary)] hover:text-blue-400 hover:bg-blue-600/20 rounded-lg transition-colors"
                    ...
                    <motion.button
                      ...
                      className="p-1.5 text-[var(--text-secondary)] hover:text-red-400 hover:bg-red-600/20 rounded-lg transition-colors"
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.9 }}
                    >
      ...
      {filteredAutomations.length === 0 && (
        ...
        >
          <CogIcon className="w-12 h-12 text-[var(--text-secondary)] mx-auto mb-4" />
      ...
      {filteredAutomations.length > 0 && (
        <motion.div
          className="bg-[var(--bg-card)] px-6 py-4 border-t border-[var(--border-subtle)]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-6">
              <span className="text-[var(--text-secondary)]">
                Total ejecuciones: <span className="text-[var(--text-primary)] font-medium">
                  {filteredAutomations.reduce((sum, a) => sum + a.runs, 0).toLocaleString('es-ES')}
                </span>
              </span>
              <span className="text-[var(--text-secondary)]">
                Ingresos generados: <span className="text-[var(--text-primary)] font-medium">
