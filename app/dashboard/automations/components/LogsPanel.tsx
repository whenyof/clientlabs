      ...
      >
        <div className="flex min-h-screen items-center justify-center p-4">
          ...
          >
              ...
              <div className="p-6">
                <div className="space-y-3">
                  {filteredLogs.map((log, index) => (
                    <motion.div
                      key={log.id}
                      className="bg-[var(--bg-main)] rounded-lg p-4 border border-[var(--border-subtle)]"
                    ...
                    >
                      ...
                      {log.result && (
                        <div className="bg-[var(--bg-surface)] rounded p-3 mb-3">
                          <div className="text-green-400 text-sm font-medium mb-1">Resultado:</div>
                          <pre className="text-[var(--text-secondary)] text-xs whitespace-pre-wrap">
                ...
                {filteredLogs.length === 0 && (
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    <FunnelIcon className="w-12 h-12 text-[var(--text-secondary)] mx-auto mb-4" />
            ...
            {/* Footer */}
            <div className="p-6 border-t border-[var(--border-subtle)] bg-[var(--bg-main)]">
