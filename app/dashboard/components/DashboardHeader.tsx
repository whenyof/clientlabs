    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg border border-[#0F766E] bg-[#0F766E] px-3 py-1.5 text-[12px] font-medium text-white transition-colors hover:bg-[#0E665F]"
        >
