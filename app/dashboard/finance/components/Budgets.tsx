...
export function Budgets() {
  ...
  if (loading) {
    return <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.03] p-5 animate-pulse h-48" />
  }
      ...
      <div className="space-y-3">
        {budgets.map((budget, index) => {
          ...
          return (
            <motion.div
              key={budget.id}
              className="p-6 bg-[var(--bg-card)] rounded-xl border border-[var(--border-subtle)]"
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--text-secondary)] text-sm">Presupuesto mensual</p>
                  </div>
                </div>
