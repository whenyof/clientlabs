          ...
          {insightCards.map((card, i) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-start gap-3 rounded-xl bg-[var(--bg-card)]/[0.03] border border-[var(--border-subtle)]/[0.08] p-4"
              >
                <span
                ...
                <p className="text-sm text-[var(--text-secondary)] font-medium leading-snug">{card.label}</p>
              </motion.div>
            )
          })}
        </div>
