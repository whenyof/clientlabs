...
export function MovementsList() {
  ...
  return (
    <div className="rounded-xl border border-[var(--border-subtle)]/[0.08] bg-[var(--bg-card)]/[0.02] overflow-hidden">
      <div className="border-b border-[var(--border-subtle)]/[0.06] px-4 py-3">
        <h3 className="text-sm font-semibold text-[var(--text-primary)]">Movimientos</h3>
      ...
      <div className="divide-y divide-white/[0.06]">
        {movements.length === 0 ? (
          <div className="p-8 text-center text-[var(--text-secondary)]">
            ...
            <p className="text-sm font-medium text-[var(--text-secondary)]">Sin actividad en este período</p>
          ...
          movements.map((m) => (
            <div
              key={m.id}
              className="flex items-center justify-between gap-4 px-4 py-3 hover:bg-[var(--bg-card)]/[0.03] transition-colors"
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium text-[var(--text-primary)] truncate">{m.label}</p>
