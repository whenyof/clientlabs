    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="relative flex-1 max-w-md">
        ...
        <input
          ...
          className="w-full rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-main)] pl-9 pr-4 py-2.5 text-sm text-[var(--text-primary)] placeholder-white/40 focus:border-[var(--border-subtle)] focus:outline-none focus:ring-1 focus:ring-white/20 transition-colors"
