  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-2">Logs de Integración</h3>
          <p className="text-[var(--text-secondary)]">Historial completo de actividades</p>
        </div>
