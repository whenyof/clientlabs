    ...
    return (
        <>
            <Dialog open={open} onOpenChange={onClose}>
                <DialogContent className="bg-[var(--bg-card)] border-[var(--border-subtle)] max-w-4xl">
                    <DialogHeader>
                            ...
                            return (
                                <button
                                    ...
                                    className={`group relative rounded-xl border p-6 text-left transition-all ${isDisabled
                                        ? "border-[var(--border-subtle)] bg-[var(--bg-main)] opacity-60 cursor-not-allowed"
                                ...
                                >
                                    ...
                                    <div className={`p-3 rounded-lg w-fit mb-4 ${isDisabled
                                        ...
                                        <Icon className={`h-6 w-6 ${isDisabled ? "text-[var(--text-secondary)]" : "text-blue-400"}`} />
                                    </div>
                ...
                <DialogContent className="bg-[var(--bg-card)] border-[var(--border-subtle)] max-w-2xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative">
                            <pre className="bg-[var(--bg-card)]/40 border border-[var(--border-subtle)] rounded-lg p-4 overflow-x-auto">
                            ...
                            <Button
                                ...
                                size="sm"
                                className="absolute top-2 right-2 bg-[var(--bg-surface)] hover:bg-[var(--bg-surface)]"
                            >
                                {copied ? (
                                    <>
