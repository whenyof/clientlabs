    ...
    return (
        <>
            <Button
                ...
                className="gap-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border-blue-500/30 text-[var(--text-primary)] hover:from-blue-500/30 hover:to-purple-500/30 hover:border-blue-500/50 transition-all shadow-lg shadow-blue-500/10"
            >
            ...
            <Dialog open={modeSelectOpen} onOpenChange={setModeSelectOpen}>
                <DialogContent className="bg-[var(--bg-card)] border-[var(--border-subtle)] max-w-2xl">
                    <DialogHeader>
                        <DialogTitle className="text-[var(--text-primary)] text-xl">¿Cómo quieres crear leads?</DialogTitle>
                    </DialogHeader>
                    ...
                    <div className="grid grid-cols-2 gap-4 py-4">
                        {modes.map((mode) => {
                            ...
                            return (
                                ...
                                >
                                    {mode.badge && (
                                        <span className="absolute top-2 right-2 px-2 py-0.5 rounded text-[10px] bg-[var(--bg-surface)] text-[var(--text-secondary)]">
                                            {mode.badge}
                                        </span>
                                    )}
