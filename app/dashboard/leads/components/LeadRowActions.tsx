        ...
        <>
                ...
                {!isReadOnly && (
                    <>
                        ...
                        <Button
                            ...
                            disabled={loading}
                            className="h-9 w-9 p-0 bg-[var(--bg-main)] border-[var(--border-subtle)] text-[var(--text-secondary)] hover:bg-[var(--bg-surface)] hover:text-[var(--text-primary)] hover:border-[var(--border-subtle)] transition-all"
                            title="Añadir nota"
                        >
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button
                            ...
                            variant="ghost"
                            disabled={loading}
                            className="h-9 w-9 p-0 hover:bg-[var(--bg-surface)] transition-all"
                        >
                            <MoreVertical className="h-4 w-4" />
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent align="end" className="w-48">
                        <DropdownMenuLabel className="text-xs text-[var(--text-secondary)]">Cambiar estado</DropdownMenuLabel>
                        <DropdownMenuSeparator />
            ...
            <Dialog open={noteDialog} onOpenChange={setNoteDialog}>
                <DialogContent className="bg-[var(--bg-card)] border-[var(--border-subtle)]">
                    ...
                    <div className="space-y-4">
                        <div>
                            <Label className="text-[var(--text-secondary)]">Nota</Label>
                            <Textarea
                                value={note}
                                onChange={(e) => setNote(e.target.value)}
                                placeholder="Escribe una nota..."
                                rows={4}
                                className="bg-[var(--bg-main)] border-[var(--border-subtle)] text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] mt-2"
                            />
                        </div>
                    </div>
                    <DialogFooter>
            ...
            <Dialog open={lostDialog} onOpenChange={setLostDialog}>
                <DialogContent className="bg-[var(--bg-card)] border-[var(--border-subtle)]">
                    ...
                    <div className="space-y-4">
                        <div>
                            <Label className="text-[var(--text-secondary)]">Razón</Label>
                            <Input
                                value={lostReason}
            ...
            <Dialog open={convertDialog} onOpenChange={setConvertDialog}>
                <DialogContent className="bg-[var(--bg-card)] border-[var(--border-subtle)]">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-3 rounded-lg bg-[var(--bg-main)]">
                            <p className="text-sm text-[var(--text-secondary)]"><strong>Lead:</strong> {lead.name}</p>
