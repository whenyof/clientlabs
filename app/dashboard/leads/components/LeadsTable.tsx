    ...
    return (
        <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-main)] p-12 text-center backdrop-blur">
            <div className="max-w-md mx-auto space-y-6">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">No se encontraron leads</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
                    <div className="p-3 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)]">
                        ...
                        <p className="text-xs font-medium text-[var(--text-primary)]">Importar CSV</p>
                        <p className="text-xs text-[var(--text-secondary)] mt-1">Carga masiva de leads</p>
                    </div>
                    <div className="p-3 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)]">
                        <Globe className="h-4 w-4 text-blue-400 mb-2" />
                        <p className="text-xs font-medium text-[var(--text-primary)]">Conectar Web</p>
                        <p className="text-xs text-[var(--text-secondary)] mt-1">Captura automática</p>
                    </div>
                    <div className="p-3 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)]">
                        <Zap className="h-4 w-4 text-green-400 mb-2" />
                        <p className="text-xs font-medium text-[var(--text-primary)]">Automatizar</p>
                        <p className="text-xs text-[var(--text-secondary)] mt-1">Flujos inteligentes</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    return (
        <>
            <div className="space-y-3">
                ...
                {leads.length > 0 && (
                    <div className="flex items-center gap-3 px-4 py-2 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)]">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                type="checkbox"
                                checked={selectedLeads.length === leads.length}
                                onChange={handleSelectAll}
                                className="w-4 h-4 rounded border-[var(--border-subtle)] bg-[var(--bg-surface)] text-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 cursor-pointer"
                            />
                                ...
                                className={`group rounded-xl border backdrop-blur-sm transition-all duration-300 hover:scale-[1.01] hover:shadow-xl cursor-pointer ${isSelected
                                    ...
                                    : isUrgent
                                        ...
                                        : needsAttention
                                            ...
                                            : "border-[var(--border-subtle)] bg-[var(--bg-main)] hover:bg-[var(--bg-surface)] hover:border-[var(--border-subtle)]"
                                    }`}
                            >
                                <div className="p-5">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-3 mb-3">
                                                ...
                                                <div className={`p-2.5 rounded-lg border transition-all ${isUrgent
                                                    ...
                                                    <SourceIcon className={`h-4 w-4 ${isUrgent ? "text-red-400" : "text-[var(--text-secondary)]"
                                                        }`} />
                                                </div>
                                                        ...
                                                        {(() => {
                                                            ...
                                                            return (
                                                                <div className="relative group">
                                                                    ...
                                                                    <div className="absolute hidden group-hover:block bottom-full left-0 mb-2 p-2 bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-lg shadow-xl whitespace-nowrap z-50">
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                ...
                                                {/* Source Badge */}
                                                {lead.source && (
                                                    <div className="px-2.5 py-1.5 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)] text-xs text-[var(--text-secondary)] font-medium">
                                                        {lead.source}
                                                    </div>
                                                )}
                                                ...
                                                {lead.tags && lead.tags.length > 0 && (
                                                    <div className="flex flex-wrap gap-1.5">
                                                        ...
                                                        {lead.tags.length > 3 && (
                                                            <span className="px-2 py-0.5 rounded-full bg-[var(--bg-main)] border border-[var(--border-subtle)] text-xs text-[var(--text-secondary)]">
                                                                +{lead.tags.length - 3}
                                                            </span>
                                                        )}
                                                    </div>
                ...
                {/* Results count */}
                <div className="flex items-center justify-between text-sm text-[var(--text-secondary)] px-2 py-2 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)]">
