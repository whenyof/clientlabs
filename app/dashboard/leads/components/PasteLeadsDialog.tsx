...
export function PasteLeadsDialog({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
    ...
    return (
        <Dialog open={open} onOpenChange={(open) => {
            ...
            <DialogContent className="bg-[var(--bg-card)] border-[var(--border-subtle)] max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
                <DialogHeader>
                    ...
                    {step === "paste" && (
                        <div className="space-y-4">
                            ...
                            <Textarea
                                ...
                                className="bg-[var(--bg-main)] border-[var(--border-subtle)] text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] min-h-[300px] font-mono text-sm"
                            />
                        </div>
                    )}
                    ...
                    {step === "preview" && (
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                <div className="p-3 rounded-lg bg-[var(--bg-main)]0/10 border border-[var(--border-subtle)]">
                            ...
                            <div className="border border-[var(--border-subtle)] rounded-lg overflow-hidden">
                                <div className="max-h-96 overflow-auto">
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody>
                                            {leads.map((lead, idx) => (
                                                <tr key={idx} className={`border-t border-[var(--border-subtle)] hover:bg-[var(--bg-main)] transition-all ${lead.excluded ? 'opacity-40' : ''
                                                    }`}>
                                                            ...
                                                            <div className="flex gap-1">
                                                                <button
                                                                    ...
                                                                    className={`px-2 py-0.5 rounded text-xs transition-all ${lead.temperature === "HOT"
                                                                        ...
                                                                        : 'bg-[var(--bg-main)] border border-[var(--border-subtle)] text-[var(--text-secondary)] hover:bg-[var(--bg-surface)]'
                                                                        }`}
                                                                >
                                                    ...
                                                    <td className="px-3 py-2">
                                                        <input
                                                            ...
                                                            placeholder="Nombre"
                                                            className={`bg-transparent border-0 outline-none w-full ${lead.excluded ? 'text-[var(--text-secondary)]' : 'text-[var(--text-primary)]'}`}
                                                        />
                                                    </td>
                                                    <td className="px-3 py-2">
                                                        <input
                                                            ...
                                                            className={`bg-transparent border-0 outline-none w-full ${lead.excluded ? 'text-[var(--text-secondary)]' : 'text-[var(--text-secondary)]'}`}
                                                        />
                                                    </td>
                                                    <td className="px-3 py-2">
                                                        <input
