                    ...
                    {categories.map((cat) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {cat.disabled && (
                                    <span className="text-[10px] px-1.5 py-0.5 rounded bg-[var(--bg-surface)]">
                                        Soon
                                    </span>
                                )}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                {selectedCategory === "temperature" && (
                                    <div className="p-3 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)] text-xs">
                                ...
                                {selectedCategory === "tags" && (
                                    <div className="p-3 rounded-lg bg-[var(--bg-main)] border border-[var(--border-subtle)] text-xs">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <ChevronRight className="h-3 w-3 text-[var(--text-secondary)]" />
                                            <span className="px-2 py-0.5 rounded bg-[var(--bg-main)]0/20 text-[var(--text-secondary)] text-[10px]">
                                                personal-email
                                            </span>
                                        </div>
                                    </div>
