        ...
        <div className="space-y-6">
            {!isCompact && (
                <div className="flex items-center justify-between">
                    ...
                    <Button onClick={() => setIsCreating(true)} size="sm" className="bg-emerald-600 hover:bg-emerald-600 text-white">
                ...
                >
                    ...
                    <div className="flex items-center gap-2 m-1 p-2 rounded-lg bg-white/5 border border-white/5">
                        <input
                            ...
                            className="rounded border-white/20 bg-black/40 text-emerald-600 focus:ring-emerald-500/50"
                    ...
                    <div className="flex justify-end gap-2 pt-2">
                        ...
                        <Button size="sm" onClick={handleCreate} className="bg-emerald-600 hover:bg-emerald-600 text-white">
                            Crear Pedido
                        </Button>
                    </div>
                </motion.div>
            ...
            <div className="space-y-3">
                {loading ? (
                    ...
                    <div className="text-center py-8 bg-dashed bg-white/5 rounded-xl border border-dashed border-white/10">
                        ...
                        {isCompact && (
                            <Button variant="link" onClick={() => setIsCreating(true)} className="text-emerald-400 text-xs mt-1">
                            ...
                            <div className="flex justify-between items-start mb-2">
                                <div className="flex items-center gap-2">
                                    <div className={cn(
                                        ...
                                        order.type === 'SERVICE' && "text-emerald-400 bg-emerald-500/10",
