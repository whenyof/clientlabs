    ...
    <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#1A1B2F] via-[#14152A] to-[#0E0F1F] p-6 shadow-2xl">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
        ...
        <button
          ...
          className="rounded-full border border-white/10 bg-gradient-to-r from-emerald-600 to-emerald-500 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-white transition hover:brightness-110"
        >
