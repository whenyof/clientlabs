      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {!isEditing ? (
          <motion.button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-600 text-white rounded-lg transition-colors"
      ...
      <div className="space-y-8">
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              <button
                ...
                className="w-20 h-20 rounded-xl overflow-hidden bg-gradient-to-br from-emerald-500 to-blue-600 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:cursor-default"
              >
                {companyData.logoUrl ? (
              ...
              {isEditing && (
                <span className="absolute -bottom-2 -right-2 w-8 h-8 bg-emerald-600 hover:bg-emerald-600 text-white rounded-full flex items-center justify-center transition-colors pointer-events-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                disabled={!isEditing}
                className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                disabled={!isEditing}
                className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="bg-gray-900/50 rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-emerald-400 mb-1">1,247</div>
