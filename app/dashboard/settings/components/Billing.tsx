    ...
    <div className="space-y-6">
      ...
      <div className="bg-[var(--bg-card)] backdrop-blur-xl border border-[var(--border-subtle)] rounded-xl p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-lg font-semibold text-[var(--text-primary)]">Plan Actual</h3>
        </div>

        <div className="flex items-center justify-between">
          <div>
            <p className="text-xl font-bold text-[var(--text-primary)]">Plan Gratuito</p>
            <p className="text-[var(--text-secondary)]">Perfecto para empezar</p>
          </div>
          <div className="text-right">
            <p className="text-2xl font-bold text-[var(--text-primary)]">€0</p>
            <p className="text-[var(--text-secondary)]">por mes</p>
          </div>
        </div>
      ...
      {/* Upgrade Plans */}
      <div className="bg-[var(--bg-card)] backdrop-blur-xl border border-[var(--border-subtle)] rounded-xl p-6">
        <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-6">Actualizar Plan</h3>
            ...
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <span className="bg-yellow-500 text-[var(--text-primary)] text-xs font-bold px-3 py-1 rounded-full">
                    MÁS POPULAR
                  </span>
                </div>
              )}
              ...
              <div className="text-center mb-4">
                <h4 className="text-lg font-semibold text-[var(--text-primary)]">{plan.name}</h4>
                <div className="mt-2">
      ...
      <div className="bg-[var(--bg-card)] backdrop-blur-xl border border-[var(--border-subtle)] rounded-xl p-6">
        ...
        <div className="space-y-3">
          {INVOICES.map(invoice => (
            <div key={invoice.id} className="flex items-center justify-between p-4 bg-[var(--bg-main)] rounded-lg">
