    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-12 flex flex-col items-center text-center">
          ...
          <h3 className="text-base font-semibold text-[#0B1F2A] mb-2">Disponible en plan Negocio</h3>
          <p className="text-sm text-slate-500 mb-5 max-w-sm">
            Los roles y permisos avanzados de equipo están disponibles en el plan Negocio. Actualiza tu plan para gestionar el acceso de cada miembro.
          </p>
          <Link
