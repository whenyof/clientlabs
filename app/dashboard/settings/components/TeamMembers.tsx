  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-2">Equipo</h2>
          <p className="text-[var(--text-secondary)]">Gestiona los miembros de tu equipo y sus permisos</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-[var(--bg-card)] rounded-xl p-4 text-center">
          <div className="text-2xl font-bold text-[var(--text-primary)] mb-1">{members.length}</div>
          <div className="text-sm text-[var(--text-secondary)]">Total miembros</div>
        </div>
        <div className="bg-[var(--bg-card)] rounded-xl p-4 text-center">
          <div className="text-2xl font-bold text-green-400 mb-1">{activeMembers}</div>
          <div className="text-sm text-[var(--text-secondary)]">Activos</div>
        </div>
        <div className="bg-[var(--bg-card)] rounded-xl p-4 text-center">
      ...
      <div className="bg-[var(--bg-card)] rounded-xl overflow-hidden">
        <div className="p-6 border-b border-[var(--border-subtle)]">
          <h3 className="text-lg font-semibold text-[var(--text-primary)]">Miembros del equipo</h3>
        </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-[var(--text-primary)] font-medium">{member.email}</div>
          ...
          >
            <div className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-[var(--text-primary)]">Invitar miembro</h3>
              </div>
