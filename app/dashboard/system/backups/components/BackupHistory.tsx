    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-[var(--text-primary)]">Backups en Google Drive</h3>
        ...
        {cloudBackups.length === 0 ? (
          <div className="text-center py-8">
            <CloudIcon className="w-16 h-16 text-[var(--text-primary)] mx-auto mb-4" />
            <p className="text-[var(--text-secondary)]">No hay backups en la nube</p>
          </div>
        ) : (
          <div className="space-y-3">
            {cloudBackups.map((backup, index) => (
              <motion.div
                key={backup.name}
                className="bg-[var(--bg-main)] rounded-lg p-4 hover:bg-[var(--bg-main)] transition-colors"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-[var(--text-primary)] font-medium">{backup.name}</div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-[var(--text-primary)]">Backups Locales</h3>
            <p className="text-[var(--text-secondary)] text-sm">
        ...
        {localBackups.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-[var(--text-secondary)]">No hay backups locales</p>
          </div>
        ) : (
          <div className="space-y-3">
