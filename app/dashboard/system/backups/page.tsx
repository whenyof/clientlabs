      ...
      <DashboardContainer>
        <div className="text-center py-12">
          ...
          <button
            ...
            className="bg-blue-600 text-[var(--text-primary)] px-6 py-2 rounded-lg hover:bg-blue-700"
          >
            Ver Planes
          </button>
        </div>
            ...
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-[var(--bg-main)] rounded-xl p-6">
                <div className="animate-pulse space-y-4">
                  <div className="w-12 h-12 bg-[var(--bg-surface)] rounded-lg"></div>
                  <div className="space-y-2">
                    <div className="h-4 bg-[var(--bg-surface)] rounded w-3/4"></div>
                    <div className="h-6 bg-[var(--bg-surface)] rounded w-1/2"></div>
                  </div>
                </div>
              </div>
            ))}
