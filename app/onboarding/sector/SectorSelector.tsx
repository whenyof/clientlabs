            ...
            return (
              ...
              >
                <div className="flex flex-col items-center text-center gap-4 relative z-10">
                  <div className="w-14 h-14 flex items-center justify-center rounded-xl bg-teal-500/10 group-hover:bg-teal-500/20 transition">
                ...
                <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition bg-gradient-to-br from-teal-500/10 to-emerald-500/10 blur-xl" />
              </button>
            )
          })}
        </div>
