...
export default function Home() {
  ...
  return (
    <main
      className="relative h-screen overflow-y-scroll text-white snap-y snap-mandatory scroll-smooth"
      style={{
        paddingTop: "var(--nav-height, 72px)",
        background: "linear-gradient(135deg, #071A1F 0%, #0B2A2F 100%)",
      }}
    >
      <Navbar />

      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(16,185,129,0.12),transparent_32%),radial-gradient(circle_at_80%_10%,rgba(52,211,153,0.08),transparent_30%)]" />
      ...
      <Section id="hero">
        <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-10 text-center px-6">
          ...
          >
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_25%_50%,rgba(16,185,129,0.1),transparent_35%),radial-gradient(circle_at_80%_50%,rgba(52,211,153,0.08),transparent_30%)]" />
            {[
              ...
              <div className="relative grid grid-cols-4 gap-8">
                {[
                  ...
                  >
                    ...
                    {/* Card flotante */}
                    <div className="relative rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-emerald-900/20 backdrop-blur transition-all duration-300 hover:-translate-y-2 hover:border-white/20 hover:bg-white/8 hover:shadow-emerald-900/30">
                      <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-white/5 via-transparent to-emerald-500/10 opacity-0 transition group-hover:opacity-100" />
              ...
              <div className="flex gap-6">
                {[
                  ...
                  >
                    ...
                    <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-emerald-900/20 backdrop-blur">
        ...
        <div ref={chaosRef} className="mx-auto flex h-full w-full max-w-7xl flex-col justify-center px-6 py-4">
          ...
          <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <motion.div
              ...
              className="relative flex flex-col overflow-hidden rounded-2xl border border-amber-500/20 bg-gradient-to-br from-amber-950/20 via-[#0d0f14] to-emerald-950/20 p-4 shadow-[0_30px_120px_rgba(251,191,36,0.12)]"
            >
              ...
              <div className="relative flex h-full flex-col items-center justify-center text-center">
                ...
                <div className="mb-6 flex flex-col items-center gap-3">
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 text-xl font-bold text-white shadow-lg shadow-emerald-800/40">
                    CL
                  </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <motion.div
                key={item.title}
                variants={fadeUp}
                className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-lg shadow-emerald-900/20"
              >
      ...
      <Section id="soporte">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-6 md:grid-cols-2">
          ...
          <motion.div
            variants={fadeUp}
            className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-emerald-900/25"
          >
      ...
      <Section id="apis">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-6 md:grid-cols-2">
          ...
          <motion.div
            variants={fadeUp}
            className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0a0c12] p-6 shadow-xl shadow-emerald-900/25"
          >
      ...
      <Section id="cta">
        <motion.div
          variants={fadeUp}
          className="mx-auto max-w-4xl space-y-6 rounded-[32px] border border-white/10 bg-gradient-to-r from-emerald-500/20 via-teal-500/15 to-blue-500/18 px-8 py-12 text-center shadow-2xl shadow-emerald-900/40 backdrop-blur"
        >
  ...
  if (variant === "primary") {
    return (
      <motion.a
        ...
        whileTap={{ scale: 0.99 }}
        href={href}
        className={`${base} bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg shadow-[0_0_40px_rgba(16,185,129,0.25)]`}
      >
        {children}
      </motion.a>
    )
...
function ColumnCard({
  ...
  return (
    <motion.div
      variants={fadeUp}
      className={`space-y-3 rounded-3xl border border-white/10 bg-gradient-to-br ${color} p-5 shadow-lg shadow-emerald-900/15`}
    >
    ...
    >
      ...
      <div className="relative mb-8 flex items-center justify-center">
        <motion.div
          ...
          className="relative rounded-2xl border border-white/15 bg-white/10 px-8 py-6 backdrop-blur shadow-lg shadow-emerald-800/30"
        >
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 text-xl font-bold text-white shadow-lg shadow-emerald-800/40">
            CL
          </div>
      ...
      <div className="relative grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        {modules.map((module, idx) => (
          <motion.div
            ...
            className="group relative"
          >
            <div className="rounded-xl border border-white/10 bg-white/5 p-3 text-center backdrop-blur transition-all duration-300 hover:border-white/20 hover:bg-white/8 hover:shadow-emerald-900/30">
