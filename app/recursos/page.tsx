...
export default function Recursos() {
 ...
 <p className="text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">Recursos</p>
 <h1 className="text-4xl md:text-6xl font-semibold leading-tight">
 Todo el <span className="text-[var(--accent)]-hover font-semibold">conocimiento</span> para operar sin improvisar
 </h1>
 ...
 <span className="text-[var(--accent)]-hover font-semibold">guías</span> y herramientas reales.
 </p>
 ...
 <span className="text-[var(--accent)]-hover font-semibold">Operaciones</span> reales, decisiones basadas en datos
 </h2>
 </div>
 ...
 key={item.title}
 href={item.href}
 className="group relative rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 md:p-6 backdrop-blur shadow-sm transition duration-300 hover:-translate-y-1 hover:border-[var(--border-subtle)] hover:shadow-sm reveal"
 >
 <div className="flex items-center gap-3 text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">
 <span className="h-2 w-2 rounded-full bg-[var(--bg-card)]" />
 {item.title}
 </div>
 <p className="mt-3 text-base font-semibold text-[var(--text-primary)]">{item.title}</p>
 <p className="mt-2 text-sm text-[var(--text-secondary)]">{item.desc}</p>
 <div className="mt-6 text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)] group-hover:text-[var(--text-primary)]">
 {item.cta}
 </div>
 </a>
 ))}
