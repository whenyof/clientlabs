...
export default function Seguridad() {
 ...
 <p className="text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">Seguridad</p>
 ...
 <div key={item.title} className="rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 backdrop-blur">
