...
export default function SolucionesClient() {
 ...
 <main
 ref={mainRef}
 className="h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth text-[var(--text-primary)]"
 >
 <Navbar />
 ...
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">Hero</p>
 ...
 <div className="max-w-6xl w-full mx-auto px-6">
 <div className="text-center mb-10">
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">Sistema adaptable</p>
 ...
 <div
 key={card.title}
 className="rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 text-left"
 >
 ...
 <div className="max-w-6xl w-full mx-auto px-6">
 <div className="text-center mb-10">
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">Agencias</p>
 ...
 <div>
 <ul className="grid gap-3 text-sm text-[var(--text-secondary)] max-w-4xl mx-auto">
 {[
 ...
 <div className="max-w-6xl w-full mx-auto px-6">
 <div className="text-center mb-10">
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">SaaS</p>
 ...
 <div className="max-w-6xl w-full mx-auto px-6">
 <div className="text-center mb-10">
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">Ecommerce</p>
 ...
 <div className="max-w-6xl w-full mx-auto px-6">
 <div className="text-center mb-10">
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">Consultoras</p>
 <h2 className="text-3xl md:text-4xl font-semibold">
 ...
 <div className="max-w-6xl w-full mx-auto px-6">
 <div className="text-center mb-10">
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">Startups</p>
 <h2 className="text-3xl md:text-4xl font-semibold">
 ...
 <div className="max-w-6xl w-full mx-auto px-6">
 <div className="text-center mb-10">
 <p className="uppercase tracking-widest text-xs text-[var(--text-secondary)]">CTA final</p>
 ...
 <footer className="mt-10 border-t border-[var(--border-subtle)] px-6 py-10 text-center text-sm text-[var(--text-secondary)]">
