...
export default function Soluciones() {
 ...
 <span className="text-[var(--accent)]-hover font-semibold">control</span> operativo.
 </p>
 ...
 <span className="text-[var(--accent)]-hover font-semibold">control</span> cuando creces.
 </h2>
 <p className="text-[var(--text-secondary)] text-base md:text-lg">
 Empresas con buen producto fallan por{" "}
 <span className="text-[var(--accent)]-hover font-semibold">sistemas</span> débiles: datos dispersos, equipos
 desalineados y decisiones a ciegas. ClientLabs nace para resolver exactamente eso.
 </p>
 <div className="grid gap-3 text-[var(--text-secondary)]">
 ...
 <div className="absolute -inset-10 rounded-[40px] bg-[var(--accent-soft)]-primary/20 " />
 <div className="relative rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 backdrop-blur">
 <div className="flex items-center justify-between border-b border-[var(--border-subtle)] pb-4 text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">
 <span>Control</span>
 <span>Live</span>
 </div>
 ...
 <div key={label} className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-4">
 ...
 <p className="text-xs text-[var(--text-secondary)]">Rendimiento operativo</p>
 <div className="mt-3 h-2 rounded-full bg-[var(--bg-card)] overflow-hidden">
 ...
 <p className="text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">
 El <span className="text-[var(--accent)]-hover font-semibold">crecimiento</span> no es el problema.
 </p>
 <h2 className="text-3xl md:text-5xl font-semibold leading-tight">
 El problema es perder el <span className="text-[var(--accent)]-hover font-semibold">control</span> cuando creces.
 </h2>
 ...
 <div className="grid gap-8 md:grid-cols-3 text-[var(--text-secondary)]">
 {[
 {
 title: "Desorden",
 ...
 <div className="text-xs uppercase tracking-[0.3em] text-[var(--text-primary)]/80">{col.title}</div>
 <div className="mt-3 text-lg md:text-xl font-semibold text-[var(--text-primary)]">{col.subtitle}</div>
 <div className="mt-4 space-y-2">
 {col.items.map((item) => (
 <div key={item} className="flex items-center gap-3">
 <span className="h-1.5 w-1.5 rounded-full bg-[var(--bg-card)]" />
 <span>{item}</span>
 </div>
 ))}
 </div>
 {index < 2 && <div className="mt-8 h-px w-full bg-[var(--accent-soft)]-primary/30 md:hidden" />}
 </div>
 ))}
 </div>

 <div className="mx-auto max-w-[680px] text-center mt-8 md:mt-14 animate-on-view delayed-emphasis">
 <p className="text-xl md:text-3xl font-semibold text-[var(--text-primary)]">
 El problema no es tu negocio.
 </p>
 <p className="mt-2 text-base md:text-2xl text-[var(--text-secondary)]">
 Es el <span className="text-[var(--text-primary)]/90">sistema</span> que lo sostiene.
 </p>
 </div>
 </div>
 </section>
 ...
 <span className="text-[var(--accent)]-hover font-semibold">sistemas</span> según tu negocio.
 </h2>
 <div className="mx-auto grid gap-4 text-[var(--text-secondary)] md:grid-cols-2">
 {[
 ...
 <span className="text-[var(--accent)]-hover font-semibold">Control</span> total en 30 días.
 </p>
 </div>
 <div className="rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 backdrop-blur">
 <div className="flex items-center justify-between border-b border-[var(--border-subtle)] pb-4 text-xs uppercase tracking-[0.3em] text-[var(--text-secondary)]">
 <span>Panel</span>
 <span>Live</span>
 </div>
 ...
 <div className="mt-5 rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-4">
 <p className="text-xs text-[var(--text-secondary)]">Automatizaciones activas</p>
 <div className="mt-3 h-2 rounded-full bg-[var(--bg-card)] overflow-hidden">
 <div className="h-full w-4/5 rounded-full bg-[var(--bg-card)]" />
 </div>
 </div>
 ...
 <p className="text-[var(--text-secondary)] text-base md:text-lg">
 Arquitectura <span className="text-[var(--accent)]-hover font-semibold">escalable</span> para crecer sin romper nada.
 </p>
 </div>
 </section>
 ...
 <span className="text-[var(--accent)]-hover font-semibold">control</span> como una empresa seria.
 </h2>
 <PrimaryButton href="/contacto">Probar gratis 14 días</PrimaryButton>
 </div>
 </div>
