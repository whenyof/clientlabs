...
export default function AuthShell() {
    return (
        <main className="dashboard-theme min-h-screen flex items-center justify-center px-6 bg-[var(--bg-main)] text-[var(--text-primary)]">
            <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
                ...
                <div className="space-y-6">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                        Los negocios <span className="text-[var(--accent)]-hover"> grandes </span> <br />
                        no crecen por
                        <span className="text-[var(--accent)]-hover"> suerte.</span>
                    </h1>
                ...
                <div className="relative flex justify-center items-center">
                    ...
                    {/* Glow */}
                    <div className="absolute -inset-8 bg-[var(--accent-soft)]-primary/20 rounded-full" />
