  ...
  return (
    <div className="space-y-6">
      ...
      <div className="form-element">
        <h2 className="text-[24px] font-bold text-slate-900 tracking-tight mb-1">Bienvenido de nuevo</h2>
      ...
      <form className="space-y-4" onSubmit={handleLogin}>
        ...
        <div className="form-element space-y-1.5">
          <div className="flex justify-between items-center">
            ...
            <a href="#" className="text-[12px] text-[#1FA97A] hover:underline">
        ...
        <button
          ...
          onMouseEnter={(e) => gsap.to(e.currentTarget, { scale: 1.02, duration: 0.15, ease: "power2.out" })}
          onMouseLeave={(e) => gsap.to(e.currentTarget, { scale: 1, duration: 0.15 })}
          className="form-element w-full py-3 bg-[#1FA97A] text-white font-semibold rounded-xl text-[14px] hover:bg-[#178f68] transition-colors disabled:opacity-50 flex items-center justify-center"
        >
