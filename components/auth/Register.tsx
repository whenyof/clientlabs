  ...
  return (
    <div className="space-y-6 pt-2">
      ...
      <form className="space-y-5" onSubmit={handleRegister}>
        ...
        <label className="flex items-center gap-2 text-xs text-white/60 ml-1">
          <input
            ...
            className="accent-emerald-500 w-4"
          />
          <span>
            Acepto los{" "}
            <a href="/terminos" target="_blank" className="text-emerald-500 hover:underline">
        ...
        <button
          ...
          className="w-full h-12 rounded-full bg-gradient-to-r from-emerald-500 to-teal-600 font-semibold disabled:opacity-40"
        >
      ...
      <p className="text-center text-sm text-white/60">
        ¿Ya tienes cuenta?{" "}
        <button onClick={onSwitch} className="text-emerald-500 hover:underline">
          Inicia sesión
        </button>
      </p>
    </div>
