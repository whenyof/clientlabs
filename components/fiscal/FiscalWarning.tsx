...
export function FiscalWarning({ clientId, isFiscalComplete, onFix }: FiscalWarningProps) {
 ...
 type="button"
 onClick={onFix}
 className="mt-3 inline-flex items-center gap-1.5 rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-card)] px-3 py-2 text-sm font-medium text-[var(--text-secondary)] hover:bg-[var(--bg-card)] transition-colors"
 >
