...
export const heroContent = {
  pill: "CRM y facturación para autónomos y pymes",
  headline: "CRM y facturación legal",
  headlineAccent: "Un solo sistema.",
  sub: "Factura con Verifactu, capta leads desde tu web, gestiona clientes y automatiza tu negocio. Todo conectado desde 17,99€/mes.",
  ctas: {
    primary:   { label: "Empezar gratis", href: "/register" },
...
export const pricingContent = {
  ...
  faqs: [
    ...
    [
      ...
      "Sí. Importamos tus clientes, leads y facturas desde CSV, Excel o los CRM más comunes. Te ayudamos sin coste adicional.",
    ],
    [
...
export const footerContent = {
  brand: { name: "ClientLabs", tagline: "CRM y facturación para autónomos y pymes." },
  newsletter: { eyebrow: "Newsletter", placeholder: "tu@email.com", cta: "Suscribirme" },
  columns: [
    {
      heading: "Producto",
      links: [
        { label: "CRM para autónomos",       href: "/producto" },
        { label: "Facturación con Verifactu", href: "/producto#facturacion" },
        { label: "Captación de leads",        href: "/producto#leads" },
    ...
    },
    {
      heading: "Empresa",
      links: [
        { label: "Sobre ClientLabs", href: "/about" },
    ...
    },
    {
      heading: "Recursos",
      links: [
        { label: "Blog para autónomos",            href: "/blog" },
        { label: "Guía Verifactu 2026",            href: "/blog/verifactu-guia-completa" },
        { label: "Mejores software de facturación", href: "/blog/mejores-software-facturacion-autonomos" },
        { label: "Cómo gestionar leads",           href: "/blog/como-gestionar-leads-autonomo" },
        { label: "Alternativa a Holded",           href: "/blog/clientlabs-vs-holded" },
      ],
    },
    {
      heading: "Legal",
      links: [
        ...
        { label: "Declaración responsable",  href: "/legal/declaracion-responsable" },
      ],
    },
  ],
  bottom: {
