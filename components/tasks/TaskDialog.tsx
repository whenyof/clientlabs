...
export function TaskDialog({ open, onOpenChange, task, clientId, leadId, entityName, onSuccess, onSubmit }: TaskDialogProps) {
 ...
 <div>
 <Label htmlFor="dueDate" className="text-[var(--text-secondary)]">Fecha</Label>
 <Input
 id="dueDate"
 type="date"
 value={dueDate}
 ...
 <div className="grid grid-cols-2 gap-4">
 <div>
 <Label htmlFor="startTime" className="text-[var(--text-secondary)]">Hora de inicio</Label>
 <Input
 id="startTime"
 type="time"
 value={startTime}
 ...
 <div>
 <Label htmlFor="duration" className="text-[var(--text-secondary)]">Duración</Label>
 <Select
 ...
 <SelectItem value="custom" className="text-[var(--text-primary)] focus:bg-zinc-700 cursor-pointer">
 Personalizado
 </SelectItem>
 </SelectContent>
 </Select>
