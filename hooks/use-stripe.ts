...
export function useStripeCheckout() {
  ...
  async function changePlan(plan: "STARTER" | "PRO" | "BUSINESS", period: "monthly" | "yearly") {
    setLoading(true)
    try {
      ...
      const msg = err instanceof Error ? err.message : "Error al cambiar el plan"
      toast.error(msg)
    } finally {
      setLoading(false)
    }
  ...
  return { checkout, openPortal, changePlan, loading }
}
