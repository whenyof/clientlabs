        ...
        <div className="flex items-center gap-2 px-3 py-2 border-t border-[var(--border-subtle)] bg-[var(--bg-card)]">
          <div className="relative flex-1">
            <select
              ...
              className="w-full text-[12px] border border-[var(--border-subtle)] rounded-md px-2 py-1.5 pr-8 bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-[#0F766E]/30"
            >
