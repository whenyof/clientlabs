...
export function ClientPaymentsList({ payments, kpis }: ClientPaymentsListProps) {
 ...
 <BanknotesIcon className="w-4 h-4 text-[var(--text-primary)]" />
 </div>
 ...
 <p className="text-sm text-[var(--text-secondary)] font-medium">Sin pagos</p>
 ...
 <tr
 key={p.id}
 className="border-b border-[var(--border-subtle)] transition-colors hover:bg-[var(--bg-card)]/[0.04]"
 >
 {/* Date */}
