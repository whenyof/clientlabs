                ...
                <div className="h-full flex flex-col overflow-hidden bg-zinc-950">
                    <div className="p-6 border-b border-white/10 bg-zinc-950 shrink-0">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="mb-6">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <p className="text-[10px] font-bold text-white/20 uppercase tracking-[0.2em] leading-none">Perfil</p>
                                    </div>
                                    <TraitsSelector
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Button onClick={() => setSaleDialog(true)} className="flex-1 bg-indigo-600 hover:bg-teal-500 text-white h-11 rounded-xl border-none">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4">
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center">
                                            {client.status === "ACTIVE" && <span className="text-sm font-bold text-emerald-400">{labels.clients.status.ACTIVE}</span>}
                                            {client.status === "FOLLOW_UP" && <span className="text-sm font-bold text-blue-400">{labels.clients.status.FOLLOW_UP}</span>}
                                            {client.status === "INACTIVE" && <span className="text-sm font-bold text-zinc-500">{labels.clients.status.INACTIVE}</span>}
                                            {client.status === "VIP" && <span className="text-sm font-bold text-amber-400">{labels.clients.status.VIP}</span>}
                                        </div>
                                    </div>
                                    <div className="space-y-1">
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-bold text-white/30 uppercase tracking-wider">{labels.sales.plural}</p>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <h3 className="text-xs font-bold text-white/40 uppercase tracking-[0.2em]">Historial de {labels.sales.plural}</h3>
                                        </div>
