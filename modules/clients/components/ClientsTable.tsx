...
function ClientsTableComponent({ clients, onClientUpdate, onClientClick }: ClientsTableProps) {
 ...
 ? "opacity-100 text-[var(--accent)] transform-none"
 ...
 <th
 className={`text-left p-4 text-sm font-medium text-[var(--text-secondary)] cursor-pointer hover:text-[var(--text-primary)] transition-colors select-none group ${className}`}
 ...
 <p className="text-[var(--text-secondary)]">{labels.common.noResults} {labels.clients.plural.toLowerCase()}</p>
 ...
 <th className="text-right p-4 text-sm font-medium text-[var(--text-secondary)]">{labels.common.actions}</th>
 </tr>
 </thead>
 <tbody>
 ...
 {/* Results count */}
 <div className="text-sm text-[var(--text-secondary)] text-center mt-4">
