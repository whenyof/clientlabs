...
export function ReminderDialog({ clientId, isOpen, onClose, onSuccess }: ReminderDialogProps) {
 ...
 {/* Quick Presets */}
 <div>
 <Label className="text-[var(--text-primary)] text-xs">Accesos rápidos</Label>
 ...
 className="bg-[var(--bg-card)] border-[var(--border-subtle)] text-[var(--text-primary)] hover:bg-[var(--bg-card)] text-xs"
 >
 {preset.label}
 </Button>
 ))}
 ...
 {/* Note */}
 <div>
 <Label className="text-[var(--text-primary)]">Nota (opcional)</Label>
 <Textarea
 value={note}
