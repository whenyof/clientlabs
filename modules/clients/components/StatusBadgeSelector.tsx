...
const STATUS_CONFIG = {
 ...
 hoverColor: "hover:bg-[var(--bg-card)]",
 },
 INACTIVE: {
 label: "Inactivo",
...
export function StatusBadgeSelector({
 ...
 <DropdownMenuContent align="start" className="bg-zinc-900 border-[var(--border-subtle)]">
 ...
 className="flex items-center justify-between gap-3 text-[var(--text-primary)] hover:bg-[var(--bg-card)] cursor-pointer"
 >
