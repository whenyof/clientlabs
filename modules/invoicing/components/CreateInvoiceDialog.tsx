...
export function CreateInvoiceDialog({
 ...
 className="fixed left-1/2 top-1/2 z-50 w-full max-w-2xl max-h-[90vh] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-main)] shadow-sm flex flex-col overflow-hidden"
 >
 ...
 {error && (
 <p className="text-sm text-[var(--critical)] bg-[var(--bg-card)] border border-[var(--critical)] rounded-lg px-3 py-2">
 {error}
 </p>
 )}
 ...
 className="w-full rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-3 py-2 text-sm text-[var(--text-primary)] focus:border-[var(--border-subtle)] focus:outline-none focus:ring-1 focus:ring-white/20 disabled:opacity-60 disabled:cursor-not-allowed"
 >
 ...
 className="w-full rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-3 py-2 text-sm text-[var(--text-primary)] focus:border-[var(--border-subtle)] focus:outline-none focus:ring-1 focus:ring-white/20 disabled:opacity-50"
 >
 <option value="">
 {loadingSales
 ? "Cargando…"
 ...
 {clientId && (
 <div ref={billingRef} className="space-y-3 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] p-4">
 <div className="flex items-center justify-between">
 <h3 className="text-xs font-medium text-[var(--text-secondary)] uppercase tracking-wider">Datos de facturación</h3>
 ...
 <p className="text-xs text-[var(--text-secondary)]">Procedente de ficha de cliente</p>
 )}
 ...
 disabled={!editableInEditMode}
 placeholder={label}
 className={`w-full rounded-lg border px-3 py-2 text-sm text-[var(--text-primary)] placeholder-white/40 disabled:opacity-60 ${billingLockedFromClient
 ? "border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.06] cursor-default"
 : "border-[var(--border-subtle)] bg-[var(--bg-card)] focus:border-[var(--border-subtle)] focus:outline-none focus:ring-1 focus:ring-white/20"
 }`}
 />
 </div>
 ))}
 ...
 className="text-xs font-medium text-[var(--accent)] hover:text-[var(--accent)] disabled:opacity-50 transition-colors"
 >
 ...
 <span className="text-xs font-medium text-[var(--text-secondary)] uppercase tracking-wider">Líneas</span>
 <button
 type="button"
 onClick={addLine}
 disabled={!editableInEditMode}
 className="inline-flex items-center gap-1 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 <thead>
 <tr className="bg-[var(--bg-card)]/[0.03] border-b border-[var(--border-subtle)]">
 <th className="text-left py-2 px-2 text-[var(--text-secondary)] font-medium">Descripción</th>
 <th className="text-right py-2 px-2 text-[var(--text-secondary)] font-medium w-20">Cant.</th>
 <th className="text-right py-2 px-2 text-[var(--text-secondary)] font-medium w-24">Precio unit.</th>
 <th className="text-right py-2 px-2 text-[var(--text-secondary)] font-medium w-20">% IVA</th>
 <th className="text-right py-2 px-2 text-[var(--text-secondary)] font-medium w-20">Total</th>
 <th className="w-10" />
 </tr>
 </thead>
 <tbody>
 ...
 disabled={!editableInEditMode}
 className="w-full rounded border border-[var(--border-subtle)] bg-[var(--bg-card)] px-2 py-1.5 text-[var(--text-primary)] placeholder-white/40 text-sm disabled:opacity-60 disabled:cursor-not-allowed"
 />
 </td>
 ...
 disabled={!editableInEditMode}
 className="w-full rounded border border-[var(--border-subtle)] bg-[var(--bg-card)] px-2 py-1.5 text-[var(--text-primary)] text-sm text-right disabled:opacity-60 disabled:cursor-not-allowed"
 />
 </td>
 <td className="py-1.5 px-2 text-right">
 <input
 ...
 disabled={!editableInEditMode}
 className="p-1 rounded text-[var(--text-secondary)] hover:text-[var(--critical)] hover:bg-[var(--bg-card)] disabled:opacity-50 disabled:cursor-not-allowed"
 ...
 <span className="text-[var(--text-secondary)] ml-4">IVA </span>
 <span className="tabular-nums">{formatCurrency(taxAmount, currency)}</span>
 <span className="text-[var(--text-secondary)] ml-4 font-medium text-[var(--text-primary)]">Total </span>
 <span className="tabular-nums font-medium">{formatCurrency(total, currency)}</span>
 </div>

 <div className="space-y-3 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] p-4">
 <h3 className="text-xs font-medium text-[var(--text-secondary)] uppercase tracking-wider">Información de pago</h3>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 <div>
 <label className="block text-xs text-[var(--text-secondary)] mb-1">Forma de pago</label>
 <select
 value={paymentMethod}
 onChange={(e) => setPaymentMethod(e.target.value)}
 disabled={!editableInEditMode}
 className="w-full rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-card)] px-3 py-2 text-sm text-[var(--text-primary)] disabled:opacity-60"
 >
 ...
 <div>
 <label className="block text-xs text-[var(--text-secondary)] mb-1">Referencia</label>
 <input
 type="text"
 ...
 className="w-full rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-card)] px-3 py-2 text-sm text-[var(--text-primary)] placeholder-white/40 disabled:opacity-60"
 />
 </div>
 <div className="sm:col-span-2">
 <label className="block text-xs text-[var(--text-secondary)] mb-1">IBAN</label>
 <input
 type="text"
 value={iban}
 ...
 <div>
 <label className="block text-xs text-[var(--text-secondary)] mb-1">BIC</label>
 <input
 type="text"
 value={bic}
 ...
 <h3 className="text-xs font-medium text-[var(--text-secondary)] uppercase tracking-wider">Legal</h3>
 <div>
 <label className="block text-xs font-medium text-[var(--text-secondary)] uppercase tracking-wider mb-1">
 Notas
 </label>
 ...
 rows={2}
 disabled={!editableInEditMode}
 className="w-full rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-3 py-2 text-sm text-[var(--text-primary)] placeholder-white/40 focus:border-[var(--border-subtle)] focus:outline-none focus:ring-1 focus:ring-white/20 disabled:opacity-60 disabled:cursor-not-allowed"
 />
 </div>
 <div>
 <label className="block text-xs font-medium text-[var(--text-secondary)] uppercase tracking-wider mb-1">
 ...
 <div className="shrink-0 flex justify-end gap-2 px-5 py-4 border-t border-[var(--border-subtle)]">
 <button
 type="button"
 onClick={onClose}
 className="rounded-xl border border-[var(--border-subtle)] px-4 py-2 text-sm text-[var(--text-secondary)] hover:bg-[var(--bg-card)]"
 >
 Cancelar
 </button>
 <button
 ...
 className="rounded-xl bg-[var(--bg-card)] px-4 py-2 text-sm font-medium text-[white] hover:bg-[var(--bg-card)] disabled:opacity-50"
 >
