...
export function InvoiceFilters({ filters, onFiltersChange, clients }: InvoiceFiltersProps) {
 ...
 className="w-full rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] pl-9 pr-4 py-2.5 text-sm text-[var(--text-primary)] placeholder-white/40 focus:border-[var(--border-subtle)] focus:outline-none focus:ring-1 focus:ring-white/20 transition-colors"
 ...
 className="w-24 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-3 py-2 text-sm text-[var(--text-primary)] placeholder-white/40 focus:border-[var(--border-subtle)] focus:outline-none focus:ring-1 focus:ring-white/20"
