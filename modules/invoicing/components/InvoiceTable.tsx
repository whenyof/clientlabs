...
function InvoiceTableComponent({
 ...
 <p className="text-sm font-medium text-[var(--text-secondary)]">Sin facturas todavía</p>
 <p className="text-xs mt-1 mb-4">Crea tu primera factura para empezar.</p>
 {onCreateClick && (
 <button
 type="button"
 onClick={onCreateClick}
 className="inline-flex items-center justify-center rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 py-2 text-sm font-medium text-[white] hover:bg-[var(--bg-card)] transition-colors"
 >
 Crear factura
 </button>
 )}
 ...
 <th className="py-3 px-4 text-right text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider w-0">
 Acciones
 </th>
 </tr>
 </thead>
