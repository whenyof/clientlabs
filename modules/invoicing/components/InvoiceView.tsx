...
export function InvoiceView() {
 ...
 <h2 className="text-lg font-semibold text-[var(--text-primary)]">Facturación</h2>
 <button
 type="button"
 onClick={handleOpenNewInvoice}
 className="inline-flex items-center gap-2 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 py-2 text-sm font-medium text-[var(--text-primary)] hover:bg-[var(--bg-card)] transition-colors shrink-0"
 >
 ...
 return (
 <div className="flex flex-wrap items-center gap-6 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] px-4 py-3 text-sm">
 <span className="text-[var(--text-secondary)]">
 Total facturado: <strong className="text-[var(--text-secondary)]">{formatCurrency(totals.totalFacturado, "EUR")}</strong>
 </span>
 <span className="text-[var(--text-secondary)]">
 Pendiente: <strong className="text-[var(--text-secondary)]">{formatCurrency(totals.pendiente, "EUR")}</strong>
 </span>
 <span className="text-[var(--text-secondary)]">
 Vencido: <strong className="text-[var(--critical)]">{totals.vencido} facturas</strong>
 </span>
 </div>
 )
 })()}
