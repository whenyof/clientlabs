    ...
    <div className="rounded-xl border border-slate-200 bg-white p-5">
      <div className="flex items-start gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#0F766E]/10">
          <BuildingOfficeIcon className="h-5 w-5 text-[#0F766E]" />
        </div>
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-3 rounded-lg border border-slate-100 bg-slate-50 px-3 py-2.5 space-y-1.5 text-xs">
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="h-3.5 w-3.5 text-[#0F766E] shrink-0" />
          ...
          <div className="mt-3 flex items-center gap-2 flex-wrap">
            <button
              ...
              disabled={activating}
              className="inline-flex items-center gap-1.5 rounded-lg bg-[#0F766E] px-4 py-2 text-sm font-medium text-white hover:bg-[#0E665F] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
