...
export function AddNoteDialog({ providerId, providerName, open, onOpenChange, onSuccess }: AddNoteDialogProps) {
 ...
 <DialogHeader>
 <DialogTitle className="text-[var(--text-primary)]">{labels.providers.actions.addNote}</DialogTitle>
 ...
 >
 {loading ? labels.common.loading : labels.providers.actions.addNote}
 </Button>
 </div>
 </form>
 </DialogContent>
