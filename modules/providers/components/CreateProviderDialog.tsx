      ...
      <DialogContent className="bg-white rounded-2xl p-0 !max-w-[520px] w-full overflow-hidden border-0 shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="px-6 py-4 border-t border-slate-100 flex justify-end gap-3">
            ...
            <button type="submit" disabled={loading || !form.name.trim()} className="px-5 py-2.5 rounded-xl bg-[#0F766E] text-white text-[13px] font-medium hover:bg-[#0E665F] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
