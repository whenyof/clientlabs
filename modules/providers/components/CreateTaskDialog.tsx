                ...
                <form onSubmit={handleSubmit}>
                    <div className="px-6 py-5 space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <label className={labelClass}>TÍTULO <span className="text-[#0F766E]">*</span></label>
                            <input
                                type="text"
                    ...
                    <div className="px-6 py-4 border-t border-slate-100 flex justify-end gap-3">
                        ...
                        <button type="submit" disabled={loading || !formData.title.trim()} className="px-5 py-2.5 rounded-xl bg-[#0F766E] text-white text-[13px] font-medium hover:bg-[#0E665F] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
