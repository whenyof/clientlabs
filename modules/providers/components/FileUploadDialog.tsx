    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-zinc-900 border-white/10 max-w-md">
                <DialogHeader>
                    <DialogTitle className="text-white">{labels.providers.actions.uploadFile}</DialogTitle>
                    <p className="text-xs text-white/40">
                        {entityType === 'ORDER' ? `Vinculando a ${labels.orders.singular.toLowerCase()}` : `Archivo general del ${labels.providers.singular.toLowerCase()}`}
                    </p>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            <SelectContent className="bg-zinc-900 border-white/10 text-white">
                                ...
                                <SelectItem value="ORDER">{labels.orders.singular}</SelectItem>
                    ...
                    <DialogFooter className="pt-4 border-t border-white/5">
                        ...
                        >
                            {loading ? labels.common.loading : labels.providers.actions.uploadFile}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
