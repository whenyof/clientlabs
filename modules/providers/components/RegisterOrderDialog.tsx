...
export function RegisterOrderDialog({ providerId, providerName, open, onOpenChange, onSuccess }: RegisterOrderDialogProps) {
 ...
 <DialogHeader>
 <DialogTitle className="text-[var(--text-primary)]">{labels.providers.actions.newOrder}</DialogTitle>
 ...
 >
 <SelectTrigger className="bg-zinc-800 border-[var(--border-subtle)] text-[var(--text-primary)]">
 <SelectValue />
 </SelectTrigger>
