...
export function ReportingView() {
 ...
 <div className="h-24 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] animate-pulse" />
 <div className="h-[320px] rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] animate-pulse" />
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
 <div className="h-[260px] rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] animate-pulse" />
 <div className="h-[260px] rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] animate-pulse" />
 </div>
 </div>
 )
