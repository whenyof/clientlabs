    ...
    return (
        <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 backdrop-blur">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
                <h3 className="text-sm font-medium text-[var(--text-secondary)]">{sl.heroChartTitle}</h3>
                    ...
                    {modes.map((m) => (
                        <button
                            ...
                            className={cn(
                                ...
                                mode === m.key ? "bg-[var(--bg-card)] text-[white]" : "text-[var(--text-secondary)] hover:text-[white]"
                            )}
                        >
                            {m.label}
                        </button>
