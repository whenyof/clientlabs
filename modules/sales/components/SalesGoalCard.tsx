        ...
        {hasGoal && (
          <>
              ...
              <div className="flex justify-between items-baseline gap-2">
                ...
                <span
                  className={cn(
                    ...
                    projectionOnTrack ? "text-emerald-400" : "text-amber-400"
                  )}
                >
            ...
            <div className="mt-3 text-sm text-white/50">
              {isComplete ? (
                <span className="text-emerald-400 font-medium">{isPurchases ? "Dentro del presupuesto" : "Objetivo cumplido"}</span>
              ) : isMonthEnd ? (
