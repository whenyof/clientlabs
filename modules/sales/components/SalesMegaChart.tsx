...
export function SalesMegaChart({
 ...
 return (
 <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] overflow-hidden backdrop-blur">
 ...
 preset === p.value ? "bg-[var(--bg-card)] text-[white]" : "text-[var(--text-secondary)] hover:text-[white]"
 )}
 >
 {p.label}
 </button>
