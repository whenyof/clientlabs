...
export function SalesOpportunitiesPanel({ opportunities }: Props) {
 ...
 <h3 className="text-sm font-medium text-[var(--text-secondary)] mb-3">Oportunidades</h3>
 {opportunities.length === 0 ? (
 <p className="text-sm text-[var(--text-secondary)]">No se detectan oportunidades de crecimiento relevantes.</p>
 ) : (
