...
export function SalesRiskPanel({ alerts }: Props) {
 ...
 <h3 className="text-sm font-medium text-[var(--text-secondary)] mb-3">Riesgos detectados</h3>
 {alerts.length === 0 ? (
 <p className="text-sm text-[var(--text-secondary)]">No hay riesgos detectados. Rendimiento estable.</p>
 ) : (
