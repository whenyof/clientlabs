      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0 -mx-4 px-4 sm:mx-0 sm:px-0 no-scrollbar sm:overflow-visible sm:flex-wrap">
          ...
          <Button
            ...
            className="h-11 sm:h-9 px-4 shrink-0 bg-emerald-600 hover:bg-emerald-600 text-white font-medium text-sm shadow-[0_0_16px_rgba(139,92,246,0.2)] whitespace-nowrap"
          >
          ...
          {mode === "sales" && (
            <Button
              ...
              className="h-11 sm:h-9 px-4 shrink-0 bg-emerald-600 hover:bg-emerald-600 text-white font-medium text-sm border border-purple-600 whitespace-nowrap"
            >
