...
export function SalesView({ initialSales, mode = "sales" }: Props) {
 ...
 className="bg-[var(--bg-card)] border-[var(--border-subtle)] text-[var(--text-primary)] pl-9 h-11 sm:h-9 text-sm min-w-[200px] sm:min-w-0"
 />
 </div>
 <Button
 type="button"
 ...
 className="h-11 sm:h-9 px-4 shrink-0 bg-violet-600 hover:bg-violet-700 text-[var(--text-primary)] font-medium text-sm shadow-sm whitespace-nowrap"
 >
 ...
 className="h-11 sm:h-9 px-4 shrink-0 bg-[var(--accent-soft)]-primary hover:bg-[var(--accent-soft)]-primary/90 text-[var(--text-primary)] font-medium text-sm border border-[var(--accent)] whitespace-nowrap"
 >
...
function CreateTaskFromInsightDialog({
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--bg-card)] backdrop- p-4">
 <div className="w-full max-w-md rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-main)]/95 p-5 shadow-sm text-[var(--text-primary)]">
 <h3 className="text-sm font-semibold text-[var(--text-secondary)]">Crear tarea</h3>
 <p className="text-sm text-[var(--text-secondary)] mt-1">{title}</p>
 <div className="grid grid-cols-3 gap-3 mt-4">
 <div>
 <label className="text-xs text-[var(--text-secondary)] block mb-1">Fecha</label>
 <input
 type="date"
 value={date}
 onChange={(e) => setDate(e.target.value)}
 className="w-full rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-card)] px-2 py-1.5 text-sm text-[var(--text-primary)]"
 />
 </div>
 <div>
 <label className="text-xs text-[var(--text-secondary)] block mb-1">Hora</label>
 <input
 type="time"
 value={startTime}
 ...
 <div>
 <label className="text-xs text-[var(--text-secondary)] block mb-1">Duración</label>
 <select
 ...
 <Button type="button" variant="ghost" size="sm" onClick={onClose} className="text-[var(--text-secondary)]">
 Cancelar
 </Button>
 <Button
 type="button"
