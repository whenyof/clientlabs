        ...
        <div className="flex justify-between items-baseline gap-2">
          ...
          <span
            className={cn(
              ...
              result.growthPct >= 0 ? "text-emerald-400" : "text-red-400/90"
            )}
          >
            {result.growthPct >= 0 ? "+" : ""}
            {result.growthPct}%
    ...
    <div>
      ...
      <div className="flex items-center gap-1.5">
        <input
          ...
          className="flex-1 min-w-0 rounded-lg bg-white/5 border border-white/10 px-3 py-2 text-sm text-white tabular-nums focus:outline-none focus:ring-1 focus:ring-emerald-500/50"
        />
        {suffix ? (
