...
export function TaskDialog({ open, onOpenChange, task, clientId, leadId, onSuccess, onSubmit }: TaskDialogProps) {
 ...
 <Label htmlFor="title" className="text-[var(--text-primary)]">{ui.formTitle}</Label>
 <Input
 id="title"
 value={title}
 ...
 <div className="grid gap-2">
 <Label htmlFor="priority" className="text-[var(--text-primary)]">{ui.formPriority}</Label>
 ...
 <div className="grid gap-2">
 <Label htmlFor="type" className="text-[var(--text-primary)]">{ui.formType}</Label>
 ...
 <div className="grid gap-2">
 <Label htmlFor="date" className="text-[var(--text-primary)]">{ui.formDueDate}</Label>
 <Input
 id="date"
 type="date"
 value={dueDate}
 ...
 <div className="grid grid-cols-2 gap-4">
 <div className="grid gap-2">
 <Label htmlFor="startTime" className="text-[var(--text-primary)]">Hora de inicio</Label>
 <Input
 id="startTime"
 type="time"
 value={startTime}
 ...
 <div className="grid gap-2">
 <Label htmlFor="duration" className="text-[var(--text-primary)]">Duración</Label>
 <Select
 ...
 <DialogFooter>
 <Button variant="outline" onClick={() => onOpenChange(false)} disabled={loading} className="bg-[var(--bg-card)] border-[var(--border-subtle)] text-[var(--text-primary)] hover:bg-[var(--bg-card)]">
 {ui.cancel}
 </Button>
