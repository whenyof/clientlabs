...
const KPI_BASE = "rounded-lg bg-[var(--bg-card)]/[0.03] border border-[var(--border-subtle)] min-w-0 flex flex-col justify-center"

function KPISkeleton() {
 return (
 <div className={cn(KPI_BASE, "h-20 animate-pulse")}>
 <div className="px-4 py-3">
 <div className="h-6 w-10 rounded bg-[var(--bg-card)] mb-1.5" />
 <div className="h-3 w-16 rounded bg-[var(--bg-card)]" />
 </div>
 </div>
 )
}
...
function KPICell({
 ...
 <span className="text-2xl font-semibold tabular-nums text-[var(--text-primary)] leading-tight block">
 {value}
 </span>
