...
const RADAR_CARD_BASE =
 "rounded-xl bg-[var(--bg-card)]/[0.04] border border-[var(--border-subtle)] backdrop- transition-colors min-w-0"

function RadarCardSkeleton() {
 return (
 <div className={cn(RADAR_CARD_BASE, "animate-pulse")}>
 <div className="p-4 flex flex-col gap-2">
 <div className="h-3.5 w-20 rounded bg-[var(--bg-card)]" />
 <div className="h-8 w-12 rounded bg-[var(--bg-card)]" />
 </div>
 </div>
 )
}
...
function RadarCard({
 ...
 return (
 <div className={cn(RADAR_CARD_BASE, accentBorder, "hover:bg-[var(--bg-card)]/[0.06]")}>
