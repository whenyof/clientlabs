...
/** Build startAt/endAt for a day from minutes- and duration. */
...
function DraggableTaskCard({
 ...
 <DropdownMenuContent
 align="end"
 className="bg-zinc-900 border-zinc-700 text-[var(--text-primary)]"
 >
 <DropdownMenuItem
 className="text-zinc-200 focus:bg-zinc-800 focus:text-[var(--text-primary)]"
 onSelect={(e) => {
 e.preventDefault()
 onOpenMove(task)
 }}
...
export function MissionCalendar({
 ...
 <DialogContent className="bg-zinc-900 border-zinc-800 text-[var(--text-primary)] max-w-sm">
 <DialogHeader>
 <DialogTitle className="text-[var(--text-primary)]">Mover tarea</DialogTitle>
 </DialogHeader>
 ...
 <Button
 variant="ghost"
 className="text-zinc-400 hover:text-[var(--text-primary)]"
