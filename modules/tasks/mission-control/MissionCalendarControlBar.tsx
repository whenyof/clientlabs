...
export const MissionCalendarControlBar = memo(function MissionCalendarControlBar({
 ...
 <div
 className={cn(
 "flex items-center justify-between gap-4 h-12 px-4 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] shrink-0",
 className
 )}
 >
 ...
 variant="ghost"
 size="icon"
 className="h-8 w-8 text-zinc-400 hover:text-[var(--text-primary)] hover:bg-[var(--bg-card)]"
 aria-label="Anterior"
 onClick={onPrev}
 >
 ...
 variant="ghost"
 size="sm"
 className="h-8 px-2 text-xs font-medium text-zinc-400 hover:text-[var(--text-primary)] hover:bg-[var(--bg-card)]"
 onClick={onToday}
 >
 Hoy
 </Button>
 ...
 <div className="flex items-center rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] p-0.5">
 {VIEWS.map((v) => (
 <button
 key={v.id}
 type="button"
 ...
 : "text-zinc-400 hover:text-[white] hover:bg-[var(--bg-card)]"
 )}
 >
 {v.label}
 </button>
 ...
 className="h-8 pl-7 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] text-zinc-300 text-xs placeholder:text-zinc-500"
 />
 </div>
 <Select>
 <SelectTrigger className="h-8 w-[100px] rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] text-zinc-300 text-xs">
