...
export function TasksMissionControl({
 ...
 <div
 className={cn(
 "flex flex-col flex-1 min-h-0 w-full min-w-0 max-w-none text-[var(--text-primary)]",
 className
 )}
 ...
 "border-white/[0.06] bg-[var(--bg-card)]/[0.02] hover:bg-[var(--bg-card)]/[0.05] hover:border-white/[0.14]",
 taskFilter === filter && "border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.06]"
 )}
 >
 <p className="text-[10px] uppercase tracking-wider text-[var(--text-secondary)] truncate">{label}</p>
 <p className="text-lg font-semibold text-[var(--text-primary)] tracking-tight mt-0.5 truncate tabular-nums">
 {value}
 </p>
 </button>
 ))}
 ...
 <div
 className="shrink-0 w-[380px] flex flex-col rounded-xl bg-[var(--bg-card)]/[0.03] backdrop-blur border border-white/[0.06]"
 style={{ minWidth: 380, height: "100%" }}
 >
 <div className="shrink-0 pt-5 px-4 pb-2">
 <h2 className="text-lg font-semibold text-[var(--text-primary)] tracking-tight">Ejecución</h2>
 </div>
 ...
 <div className="rounded-xl bg-[var(--bg-card)]/[0.02] p-4">
 ...
 <div className="rounded-xl bg-[var(--bg-card)]/[0.02] p-5">
 ...
 <div
 ref={taskExplorerRef}
 className="mt-6 flex flex-col gap-4 bg-[var(--bg-card)]/[0.01]"
 >
 <div className="flex items-center justify-between gap-2">
 <h2 className="text-sm font-semibold text-[var(--text-primary)] tracking-tight">Task Explorer</h2>
 <span className="text-xs uppercase tracking-wide text-[var(--text-secondary)]">
 Filtro: {taskFilterLabel}
 </span>
 </div>

 <div className="max-h-[400px] overflow-y-auto rounded-lg border border-white/[0.06] bg-[var(--bg-card)]/[0.01]">
 <table className="w-full text-left border-collapse">
 <thead className="sticky top-0 z-10 bg-[var(--bg-sidebar)] border-b border-white/[0.08] shadow-sm">
 ...
 <tr>
 <td colSpan={8} className="py-6 px-3 text-xs text-[var(--text-secondary)] text-center">
 ...
 taskCompleted
 ? "opacity-75 bg-[var(--bg-card)]/[0.02] border-white/[0.08] hover:bg-[var(--bg-card)]/[0.04]"
 : "hover:bg-[var(--bg-card)]/[0.04]"
 )}
 >
 <td className="py-2 px-3 text-xs text-[var(--text-secondary)] tabular-nums whitespace-nowrap">
 ...
 {taskCompleted && <Check className="w-3.5 h-3.5 text-[var(--accent)] shrink-0" aria-hidden />}
 <span className={cn("truncate", taskCompleted ? "text-[var(--text-secondary)] line-through" : "text-[var(--text-primary)]")}>
 {task.title}
 </span>
 </span>
 </td>
 <td className="py-2 px-3 text-xs text-[var(--text-secondary)] truncate max-w-[120px]">
 {task.clientName ?? task.leadName ?? "—"}
 </td>
 <td className="py-2 px-3 text-xs text-[var(--text-secondary)] truncate max-w-[100px]">
 {task.assignedTo ?? "—"}
 </td>
 ...
 level === "high" && "bg-[var(--bg-card)] text-[var(--critical)] border border-[var(--critical)]",
 level === "medium" &&
 "bg-[var(--bg-card)] text-[var(--text-secondary)] border border-[var(--border-subtle)]",
 level === "low" && "bg-[var(--bg-card)] text-[var(--text-secondary)] border border-[var(--border-subtle)]"
 )}
 >
 ...
 <td className="py-2 px-3">
 {riskActive ? (
 <span className="text-[10px] px-1.5 py-0.5 rounded bg-[var(--bg-card)] text-[var(--text-secondary)]">
 Sí
 </span>
 ) : (
 ...
 className="text-[10px] px-2 py-1 rounded border border-[var(--border-subtle)] hover:bg-[var(--bg-card)] text-[var(--text-secondary)]"
 >
 Completar
 </button>
 <button
