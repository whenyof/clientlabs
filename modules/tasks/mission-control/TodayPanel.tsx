...
export function TodayPanel({
 ...
 <aside
 className={cn(
 "flex flex-col min-h-0 overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.02] backdrop- sticky top-0",
 className
 )}
 aria-label="Hoy"
 >
 <h2 className="text-sm font-semibold text-[var(--text-primary)] px-4 py-3 border-b border-[var(--border-subtle)] shrink-0">
 Hoy
 </h2>
 ...
 isCompleted
 ? "opacity-75 border border-white/[0.08] bg-[var(--bg-card)]/[0.02] hover:bg-[var(--bg-card)]/[0.04]"
 : "border border-[var(--border-subtle)] bg-[var(--bg-card)]/[0.03] hover:bg-[var(--bg-card)]/[0.06] hover:border-[var(--border-subtle)] hover:shadow-sm"
 )}
 >
 ...
 <span className={cn("text-[11px] shrink-0", isCompleted ? "text-[var(--text-secondary)]" : "text-zinc-500")}>
 {status}
 </span>
 </div>
 <p
